...
<body>
  <main>
    <h1 data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease-out-sine" id="">
      Nous joindre
    </h1>
      ...
      <div class="formBox">
        <form method="post" action="">
          ...
          <div>
            ...
            <br />
            <input onclick="sendMail()" type="submit" name="insert" id="bouton_valider" value="Valider" />
